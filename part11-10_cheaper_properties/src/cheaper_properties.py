...
def cheaper_properties(properties: list, reference: RealProperty):
    return [(cheap, reference.price_per_sqm * reference.square_meters - cheap.price_per_sqm * cheap.square_meters) for cheap in properties if cheap.price_per_sqm * cheap.square_meters < reference.price_per_sqm * reference.square_meters]
